  ...
  <div class="large-12 columns content-bg">
            ...
            <div class="large-12 columns">
              <div class="custom-panel">
                <div class="custom-panel-heading">
                  <h4>Edit Flip Newspaper</h4>
                </div>
                <?php
	
	$id = $_REQUEST ['id'];
	
      $userQ="select * from flip where id='$id'";
	...
	?>
                <div class="custom-panel-body">
                  <form action="update_flip.php?id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
                    <label> <span>Title :</span>
                      <input type="text" name="title" value="<?php echo $userRow['title']; ?>" required="required">
                    </label>
                    ...
                    <label> <span>Image1</span> <img src="../flip/flipPaper/pages/<?php echo $userRow['pic'];?>"
								width="100px" height="90px" /> </label>
                    
                    <input type="submit" class="button tiny radius coral-bg right" name="submit" value="Update Flip News">
