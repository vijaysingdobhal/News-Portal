            ...
            <div class="large-12 columns">
              <div class="custom-panel blue-bg">
                <div class="custom-panel-body"> <br />
                  <a class="button tiny radius success lable js-open-modal btn" href="add_video.php">
				  Add New Video</a><br>
                  <br>
                  <br>
                  <table class="width-100 custom-table responsive">
                    ...
                    <tbody>
                      <?php
  $count1=1;
        $userQ="select * from video order by Date desc";
...
?>
                      <tr>
                        ...
                        <td><?php echo $userRow['subject']; ?></td>
                        <td><?php echo ucfirst($userRow['video']); ?></td>
                        <td><?php echo $userRow['date']; ?></td>
                        <td><a class="alert label js-open-modal btn editsubcat" href="#"
						data-modal-id="popup1" rel="<?php echo $userRow['id'];?>">Edit</a>
                        
<a onClick="return confirm('Are you sure you want to delete?')"
 href="delete_video.php?id=<?php echo $userRow['id'];?>&videoName=<?php echo $userRow['video']; ?>" class="label"> Delete</a>
                        <?php if ($userRow ['status'] == 'active'){?>
<a class="label success" href="video_status.php?id=<?php echo $userRow['id'];?>&status=<?php echo $userRow['status'];?>">Active</a>
<?php }else{?>
<a class="alert label" href="video_status.php?id=<?php echo $userRow['id'];?>&status=<?php echo $userRow['status'];?>">Inactive</a>
<?php }?>
                        </td>
                      </tr>
                      <?php
