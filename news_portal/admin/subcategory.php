            ...
            <div class="large-12 columns">
              <div class="custom-panel blue-bg">
                <div class="custom-panel-body"> <br />
                  <a class="button tiny radius success lable js-open-modal btn" href="#" data-modal-id="popup2">Add Sub Category</a><br>
                  <br>
                  <br>
                  <table class="width-100 custom-table responsive">
                    ...
                    <tbody>
                      <?php
  $count1=1;
        $userQ="select * from subcategory order by Date desc";
...
?>
                      <tr>
                        ...
                        <td><?php echo ucfirst($userRow['subcategory']); ?></td>
                        <td><?php echo $userRow['date']; ?></td>
                        <td><a class="alert label js-open-modal btn editsubcat" href="#" data-modal-id="popup1" rel="<?php echo $userRow['id'];?>">Edit</a>
                        
                         <a onClick="return confirm('Are you sure you want to delete?')" href="delete_subcat.php?id=<?php echo $userRow['id'];?>" class="label"> Delete</a>
                        <?php if ($userRow ['status'] == 'active'){?>
<a class="label success" href="subcat_status.php?id=<?php echo $userRow['id'];?>&status=<?php echo $userRow['status'];?>">Active</a>
<?php }else{?>
<a class="alert label" href="subcat_status.php?id=<?php echo $userRow['id'];?>&status=<?php echo $userRow['status'];?>">Inactive</a>
<?php }?>
                        </td>
                      </tr>
                      <?php
