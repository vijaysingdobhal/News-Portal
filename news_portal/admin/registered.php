...
<body>
                ...
                <div
					...
					<div class="row">
						<div class="large-10 columns">
							<div class="page-name">
								<h3 class="left">View Registered User</h3>
  ...
  <?php
  $count1=1;
        $userQ="select * from register order by date DESC";
...
<td><?php echo ucfirst($userRow['email']); ?></td>
<td><?php echo ucfirst($userRow['mobile']); ?></td>
<td> 
<!--<a class="alert label btn" href="editcategory.php?id=<?php //echo $userRow['id'];?>">Edit</a> -->
<?php if ($userRow ['status'] == 'active'){?>
<a class="label success" href="regstatus.php?id=<?php echo $userRow['id'];?>&status=<?php echo $userRow['status'];?>">Active</a>
<?php }else{?>
<a class="alert label" href="regstatus.php?id=<?php echo $userRow['id'];?>&status=<?php echo $userRow['status'];?>">Inactive</a>
<?php }?>
</td>
</tr>
