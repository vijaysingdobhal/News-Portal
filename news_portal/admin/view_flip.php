...
<a class="button tiny radius success lable js-open-modal btn" href="add_flip.php" >Add  Flip Newspaper</a><br><br/>
...
<td><?php echo ucfirst($userRow['title']); ?></td>
<td><?php echo $userRow['pic']; ?></td>
<td> 
<a class="alert label btn" href="edit_flip.php?id=<?php echo $userRow['id'];?>">Edit</a> 

<a class="label success" href="delete_flip.php?id=<?php echo $userRow['id'];?>">Delete</a>
