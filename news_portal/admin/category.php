							...
							<div class="row">
								<div class="large-12 columns">
									<div class="custom-panel">
										...
										<label> <span>Category :</span> <input type="text" name="category" placeholder="Category" required
										 />
									</label>
                                    <label> <span>upload Image :</span> <input type="file" name="img" placeholder="Category" required
										 />
									</label>
